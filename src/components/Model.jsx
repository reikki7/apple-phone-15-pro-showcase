...
const Model = () => {
    ...
    // Refs for the camera controls
    const cameraControlSmall = useRef();
    const cameraControlLarge = useRef();

    // Refs for the small and large models
                    ...
                    <div className='w-full mx-auto'>
                        ...
                        <div className='flex-center'>
                            <ul className='color-container'>
                                {models.map((item, i) => (
                                    <li key={i} style={{ backgroundColor: item.color[0] }} className='w-6 h-6 mx-2 rounded-full' onClick={() => setModel(item)} />
                                ))}
                            </ul>
